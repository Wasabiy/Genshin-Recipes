...
function RecipeInfoPage() {
    ...
    return (
        ...
        <section id="detailList">
            <ul id="details">
                <li key={"stars"}> Rarity: {[...Array(details?.rarity)].map((index) => (
                ...
                <section id="ingredientBox">
                    ...
                    <div id="ingredientList">
                        {details?.recipe.map(x =>
                            <p key={x.item}>{x.item} x {x.quantity}</p>
                            )}
                    </div>
                </section>
                <section id="descBox">
        ...
        <section id="imgSection">
            <img src={`https://genshin.jmp.blue/consumables/food/${details?.key}`}  alt={"Image of the dish named: " +details?.name}/>
        </section>
        </>
    )
